...
<div class="row">
		<div class="col-12 mx-5 my-5">
			<h1 class="display-3 text-center my-5">Grand Theft Auto</h1>
			<p class="lead mx-5">Grand Theft Auto (oft abgekürzt als GTA) ist eine Computerspielserie des schottischen Entwicklerstudios Rockstar North, die Action-, Rennspiel-, Open-World-Spiel- und Third-Person-Shooter-Elemente enthält. 
...
Diese führen in der Regel nicht die Haupthandlung weiter, sondern belohnen den Spieler mit Geld, Waffen oder ähnlich nützlichen Boni.</p>
		</div>
	</div>
